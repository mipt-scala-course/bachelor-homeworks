...
object Homework {
    ...
    object SceneplayPrograms {
        def julietInitPlay(prompter: Prompter)(implicit theaterGoers: Odeum[String]) =
            select(
                ask(prompter), (sugg:String) => sugg == """suggest: "Last sleep" and give the Special potion"""
            )(
        ...
        def romeoPlay(prompter: Prompter)(implicit theaterGoers: Odeum[String]) =
            select(
                ask(prompter), (sugg:String) => sugg == """suggest: "Juliet is dead" and give the Poison flask"""
            )(
        ...
        def julietFinishPlay(prompter: Prompter)(implicit theaterGoers: Odeum[String]) =
            select(
                ask(prompter), (sugg:String) => sugg == """suggest: "Romeo is dead" and give the Stiletto"""
            )(
    ...
    def finalProgram(implicit theaterGoers: Odeum[String]) =
        combine(
            combine(
                julietInitPlay(prompterProgramInit), romeoPlay(prompterProgramNext)
            ),
