...
/**
 * I.1) Реализовать метод toInt, который на входе в качестве типа A берет натуральное число в кодировке Пеано,
...
/**
 * I.2) Реализовать тип ToInt[X], который на входе в качестве типа A берет натуральное число в кодировке Пеано,
...
/**
 * I.3) Реализовать тип +[X , Y], который складывает натуральные числа
 *
...
/**
 * I.4) Реализовать тип ==[X , Y], который проверяет что натуральные числа равны
 *
...
/**
 * I.5) Реализовать тип -[X, Y], который вычитает натуральные числа
...
/**
 * I.6) Реализовать тип *[X, Y], который перемножает натуральные числа
 *
